...
//		// ----- TWEETS -----
		...
		tweet2.setDelete(false);
		tweet2.setContent("This is some content 2 #eldenlord #mario");
		...
		tweet3.setDelete(false);
		// Set Content @PARAM String
		tweet3.setContent("This is some content 3 #luigi #whereiscortana");
